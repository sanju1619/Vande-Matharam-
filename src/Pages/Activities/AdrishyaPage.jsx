...
import socialImage from '../../assets/images/img1.jpg';
  ...
  const settings = {
    ...
    infinite: true,
    speed: 500,
    slidesToShow: 3, // number of images per view
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 2000,
    responsive: [
    ...
    <div className="font-sans">
        ...
        {galleryPhotos.map((photo, index) => (
          <div key={index} className="p-2">
            <img
              ...
              className="w-80 h-56 rounded-lg shadow-md object-cover mx-auto"
            />
          </div>
        ))}
      </Slider>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
        <div className="flex justify-center">
          <img src={adrishyaLogo} alt="Adrishya Logo" className="max-w-xs w-full"/>
        </div>
        <div>
      ...
      <div className="bg-white p-10 rounded-lg shadow-lg mb-20">
        ...
        <div className="flex overflow-x-auto space-x-4 p-4 -m-4 mb-8">
