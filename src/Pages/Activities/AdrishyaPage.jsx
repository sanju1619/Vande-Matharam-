...
const AdrishyaSection = () => {
  ...
  return (
    <div className="font-sans">
      {/* Full width background with inner container for content */}
      <div className="bg-gradient-to-b from-yellow-50 to-white w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="mb-16 sm:mb-20 text-center">
            ...
            />
            <h1 className="text-4xl md:text-5xl font-bold text-yellow-700 mt-6">
      ...
      {/* 4. Volunteer Section with Full Width Yellow Background */}
      <div className="bg-gradient-to-r from-yellow-100 to-yellow-200 w-full py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-10">
            <img
              src={volunteerImage}
              alt="Volunteer group"
              className="w-full h-64 sm:h-72 object-cover rounded-xl shadow-md border-4 border-yellow-400 mx-auto"
            />
          </div>
