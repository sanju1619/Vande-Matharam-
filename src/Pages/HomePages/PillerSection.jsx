    ...
    <section className="bg-white py-15 sm:py-28 ">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-y-16 md:gap-x-12">
          ...
          {/* Column 1: Our Vision (NEW Eye Icon) */}
          <PillarCard
            icon={<svg className="h-8 w-8 text-yellow-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639l4.433-7.468a1.012 1.012 0 011.724 0l4.433 7.468a1.012 1.012 0 010 .639l-4.433 7.468a1.012 1.012 0 01-1.724 0L2.036 12.322z" /><path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg>}
            title="Our Vision"
            linkTo="/about"
            linkText="Learn More"
          >
          ...
          {/* Column 2: Support a Child (NEW Heart in Hands Icon) */}
          <PillarCard
          ...
          {/* Column 3: Volunteer With Us (NEW Group of People Icon) */}
          <PillarCard
            icon={<svg className="h-8 w-8 text-yellow-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.14-4.244a3 3 0 10-4.243-4.243 3 3 0 004.243 4.243zm-2.122 4.242v.001M15.182 15.182a4.5 4.5 0 01-6.364 0 4.5 4.5 0 010-6.364l6.364-6.364a4.5 4.5 0 016.364 6.364l-6.364 6.364z" /></svg>}
